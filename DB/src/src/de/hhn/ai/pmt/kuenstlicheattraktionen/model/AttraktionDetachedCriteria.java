...
public class AttraktionDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public AttraktionDetachedCriteria() {
		super(de.hhn.ai.pmt.kuenstlicheattraktionen.model.Attraktion.class, de.hhn.ai.pmt.kuenstlicheattraktionen.model.AttraktionCriteria.class);
	...
	public AttraktionDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, de.hhn.ai.pmt.kuenstlicheattraktionen.model.AttraktionCriteria.class);
		id = new IntegerExpression("id", this.getDetachedCriteria());
		VeranstalterId = new StringExpression("Veranstalter.nachname", this.getDetachedCriteria());
		Veranstalter = new AssociationExpression("Veranstalter", this.getDetachedCriteria());
		ManagerId = new StringExpression("Manager.nachname", this.getDetachedCriteria());
	...
	public Attraktion uniqueAttraktion(PersistentSession session) {
		return (Attraktion) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public Attraktion[] listAttraktion(PersistentSession session) {
