...
public class Buga23PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Buga23";
	...
	private Buga23PersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.kuenstlicheattraktionen.model.Gruppe.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.kuenstlicheattraktionen.model.Ticket.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.kuenstlicheattraktionen.model.Veranstalter.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.kuenstlicheattraktionen.model.SystemManager.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.kuenstlicheattraktionen.model.Veranstaltung.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.kuenstlicheattraktionen.model.Event.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.kuenstlicheattraktionen.model.Attraktion.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.kuenstlicheattraktionen.model.Bewertung.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.kuenstlicheattraktionen.model.Benutzer.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Buga23PersistentManager();
		}
