...
public class SystemManager implements Serializable {
	...
	public boolean equals(Object aObj) {
		if (aObj == this)
			return true;
		if (!(aObj instanceof SystemManager))
			return false;
		SystemManager systemmanager = (SystemManager)aObj;
		if ((getNachname() != null && !getNachname().equals(systemmanager.getNachname())) || (getNachname() == null && systemmanager.getNachname() != null))
			return false;
		return true;
	}
	...
	private java.util.Set this_getSet (int key) {
		if (key == de.hhn.ai.pmt.kuenstlicheattraktionen.model.ORMConstants.KEY_SYSTEMMANAGER_VERANSTALTUNGEN) {
	...
	@OneToMany(mappedBy="Manager", targetEntity=de.hhn.ai.pmt.kuenstlicheattraktionen.model.Veranstaltung.class)	
